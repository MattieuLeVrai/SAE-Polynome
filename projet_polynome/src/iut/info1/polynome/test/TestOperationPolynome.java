...
class TestOperationPolynome {
    ...
    final void testAddition() {
        ...
        assertEquals(2, resMemeDegre.getDegre(),
                    ...
                    + resMemeDegre.getDegre());
        assertEquals(4, resMemeDegre.getCoefficient(0),
        		    "Valeur attendue : 4 | Valeur obtenue : "
                    + resMemeDegre.getCoefficient(0));
        assertEquals(5, resMemeDegre.getCoefficient(1),
        		    "Valeur attendue : 5 | Valeur obtenue : "
                    + resMemeDegre.getCoefficient(1));
        assertEquals(3, resMemeDegre.getCoefficient(2),
        		    "Valeur attendue : 3 | Valeur obtenue : "
                    + resMemeDegre.getCoefficient(2));
        ...
        assertEquals(3, resDegDiff.getDegre(),
        		     "Valeur attendue : 3 | Valeur obtenue : "
                     + resDegDiff.getDegre());
        assertEquals(5, resDegDiff.getCoefficient(0),
        		     "Valeur attendue : 5 | Valeur obtenue : "
                     + resDegDiff.getCoefficient(0));
        assertEquals(4, resDegDiff.getCoefficient(1),
        		     "Valeur attendue : 4 | Valeur obtenue : "
                     + resDegDiff.getCoefficient(1));
        ...
        assertTrue(resCompensation.estNul() || resCompensation.getDegre() == 0
        		  && resCompensation.getCoefficient(0) == 0,
        		  "Le polynôme devrait s'annuler après compensation.");
    }
    ...
    final void testSoustraction() {
        ...
        assertEquals(3, resDegDiff.getDegre(),
        		    "Valeur attendue : 3 | Valeur obtenue : "
                    + resDegDiff.getDegre());
        assertEquals(3, resDegDiff.getCoefficient(0),
        		    "Valeur attendue : 3 | Valeur obtenue : "
                    + resDegDiff.getCoefficient(0));
        assertEquals(2, resDegDiff.getCoefficient(1),
        		    "Valeur attendue : 2 | Valeur obtenue : "
                    + resDegDiff.getCoefficient(1));
        ...
        assertTrue(resAnnulation.estNul() || resAnnulation.getCoefficient(0) == 0,
        		   "Le polynôme devrait être nul après soustraction par lui-même.");
    }
    ...
    final void testMultiplicationScalaireParZero() {
        ...
        assertTrue(resultat.estNul(),
        		  "Le résultat doit être nul après multiplication par 0");
    }
    ...
    final void testMultiplication() {
        ...
        assertEquals(1, resLinQuad.getCoefficient(0),
        		    "Valeur attendue : 1 | Valeur obtenue : "
                     + resLinQuad.getCoefficient(0));
        assertEquals(3, resLinQuad.getCoefficient(1),
        		     "Valeur attendue : 3 | Valeur obtenue : "
                      + resLinQuad.getCoefficient(1));
        assertEquals(3, resLinQuad.getCoefficient(2),
        		     "Valeur attendue : 3 | Valeur obtenue : "
                     + resLinQuad.getCoefficient(2));
        assertEquals(1, resLinQuad.getCoefficient(3),
        		     "Valeur attendue : 1 | Valeur obtenue : "
                     + resLinQuad.getCoefficient(3));

        // 3. Constante × P
        Polynome resConstP = op.multiplication(pConstante3, pQuadratique);
        assertEquals(3, resConstP.getCoefficient(0),
        		    "Valeur attendue : 3 | Valeur obtenue : "
                     + resConstP.getCoefficient(0));
        assertEquals(9, resConstP.getCoefficient(1),
        		     "Valeur attendue : 9 | Valeur obtenue : "
                     + resConstP.getCoefficient(1));

        // 4. Un polynôme nul
        Polynome resUnNul = op.multiplication(pQuadratique, pNul);
        assertTrue(resUnNul.estNul(),
        		  "Le produit avec un polynôme nul doit être nul.");

        // 5. Deux polynômes nuls
        Polynome resDeuxNuls = op.multiplication(pNul, pNul);
        assertTrue(resDeuxNuls.estNul(),
        		  "Le produit de deux polynômes nuls doit être nul.");
    }
    ...
    final void testDivision() {
        ...
        assertEquals(1, quotExact.getCoefficient(0),
        		    "Valeur attendue : 1 | Valeur obtenue : "
                     + quotExact.getCoefficient(0));
        assertEquals(1, quotExact.getCoefficient(1),
        		     "Valeur attendue : 1 | Valeur obtenue : "
                     + quotExact.getCoefficient(1));
        ...
        assertEquals(1, quotAvecReste.getDegre(),
        		     "Valeur attendue : 1 | Valeur obtenue : "
                     + quotAvecReste.getDegre());
        assertEquals(1, quotAvecReste.getCoefficient(0),
        		     "Valeur attendue : 1 | Valeur obtenue : "
                     + quotAvecReste.getCoefficient(0));

        // 3. Degré inférieur (deg P1 < deg P2) -> quotient nul
        Polynome quotDegInf = op.division(pLinaire, pQuadratique);
        assertTrue(quotDegInf.estNul() || quotDegInf.getDegre() == 0
        		   && quotDegInf.getCoefficient(0) == 0,
        		   "Le quotient devrait être nul si le degré du dividende est inférieur.");
        ...
        assertEquals(0.2, quotConst.getCoefficient(0), 1e-9,
        		     "Valeur attendue : 0.2 | Valeur obtenue : "
                      + quotConst.getCoefficient(0));
        assertEquals(0.6, quotConst.getCoefficient(1), 1e-9,
        		     "Valeur attendue : 0.6 | Valeur obtenue : "
                     + quotConst.getCoefficient(1));
        assertEquals(0.4, quotConst.getCoefficient(2), 1e-9,
        		     "Valeur attendue : 0.4 | Valeur obtenue : "
                     + quotConst.getCoefficient(2));
    }
    ...
    final void testReste() {
        ...
        assertEquals(0, resteNonNul.getDegre(),
                     ...
                     + resteNonNul.getDegre());
        assertEquals(2, resteNonNul.getCoefficient(0),
        		    "Valeur attendue : 2 | Valeur obtenue : "
                     + resteNonNul.getCoefficient(0));
        ...
        assertEquals(1, resteDegInf.getDegre(),
        		     "Valeur attendue : 1 | Valeur obtenue : "
                     + resteDegInf.getDegre());
        assertEquals(1, resteDegInf.getCoefficient(0),
        		    "Valeur attendue : 1 | Valeur obtenue : "
                     + resteDegInf.getCoefficient(0));
    ...
    final void testDerivee() {
        ...
        assertEquals(3, resQuad.getCoefficient(0),
        		    "Valeur attendue : 3 | Valeur obtenue : "
                    + resQuad.getCoefficient(0));
        assertEquals(4, resQuad.getCoefficient(1),
        		    "Valeur attendue : 4 | Valeur obtenue : "
                     + resQuad.getCoefficient(1));
        ...
        assertEquals(1, resLin.getCoefficient(0),
        		     "Valeur attendue : 1 | Valeur obtenue : "
                     + resLin.getCoefficient(0));

        // 4. Nul : (0)' = 0
        Polynome resNul = op.derivee(pNul);
        assertTrue(resNul.estNul(), 
        		   "La dérivée d'un polynôme nul doit être nulle.");
    }
    ...
    final void testDeriveeConstante() {
        ...
        assertTrue(resultat.estNul(),
        		   "La dérivée d'une constante doit être le polynôme nul");
    }
    ...
    final void testPrimitive() {
        ...
        assertEquals(0.0, primLin.getCoefficient(0),
        		    "Valeur attendue : 0.0 | Valeur obtenue : "
                     + primLin.getCoefficient(0));
        assertEquals(1.0, primLin.getCoefficient(1),
        		    "Valeur attendue : 1.0 | Valeur obtenue : "
                    + primLin.getCoefficient(1));
        assertEquals(0.5, primLin.getCoefficient(2),
        		    "Valeur attendue : 0.5 | Valeur obtenue : "
                    + primLin.getCoefficient(2));
        ...
        assertEquals(0.0, primQuad.getCoefficient(0),
        		      "Valeur attendue : 0.0 | Valeur obtenue : "
                      + primQuad.getCoefficient(0));
        assertEquals(1.0, primQuad.getCoefficient(1),
        		     "Valeur attendue : 1.0 | Valeur obtenue : "
                     + primQuad.getCoefficient(1));
        assertEquals(1.0, primQuad.getCoefficient(2), 
        		     "Valeur attendue : 1.0 | Valeur obtenue : "
                      + primQuad.getCoefficient(2));
        assertEquals(1.0 / 3.0, primQuad.getCoefficient(3), 1e-9,
        		     "Valeur attendue : 0.333333333 | Valeur obtenue : "
                     + primQuad.getCoefficient(3));
        ...
        assertEquals(0.0, primConst.getCoefficient(0),
        		     "Valeur attendue : 0.0 | Valeur obtenue : "
                      + primConst.getCoefficient(0));
        assertEquals(3.0, primConst.getCoefficient(1),
        		    "Valeur attendue : 3.0 | Valeur obtenue : "
                    + primConst.getCoefficient(1));

        // 4. Nul : primitive de 0 = 0
        Polynome primNul = op.primitive(pNul);
        assertTrue(primNul.estNul(),
        		   "La primitive d'un polynôme nul doit être nulle.");
    }
    ...
    final void testCalculImageFonction() {
        ...
        assertEquals(5.0, imgConst, 
        		    "Valeur attendue : 5.0 | Valeur obtenue : " + imgConst);
    }
    ...
    final void testCalculImageFonctionZero() {
        ...
        assertEquals(1.0, resultat,
        		    "Valeur attendue : 1.0 | Valeur obtenue : " + resultat);
    }
    ...
    final void testCalculValeurMoyenneIntervalle() {
        // 1. Nominal : moyenne de (X) sur [0, 2]
    	// -> primitive 0.5X^2 -> intégrale (2 - 0) = 2 -> moyenne = 2 / 2 = 1.0
        Polynome p = new Polynome(new double[]{0, 1}); // P = X
        double resNominal = op.calculValeurMoyenneIntervalle(p, 0, 2);
        assertEquals(1.0, resNominal,
        		    "Valeur attendue : 1.0 | Valeur obtenue : " + resNominal);
    ...
    final void testIntegrationPolynome() {
        ...
        assertEquals(4.0, resNominal, 1e-9,
        		     "Valeur attendue : 4.0 | Valeur obtenue : " + resNominal);
        ...
        assertEquals(-4.0, resInverse, 1e-9,
        		    "Valeur attendue : -4.0 | Valeur obtenue : " + resInverse);
        ...
        assertEquals(0.0, resIdentique, 1e-9, 
        		    "Valeur attendue : 0.0 | Valeur obtenue : " + resIdentique);
    }
}